            ...
            <Form form={form} layout="vertical" size={screens.xs ? 'middle' : 'middle'}>
                ...
                <Row gutter={[screens.xs ? 8 : 16, 12]}>
                    <Col xs={24} md={12}>
                        ...
                        >
                            <Select
                                placeholder={isMobileOrTablet ? "Chọn loại đề *" : "Chọn loại đề"}
                                value={testType}
                    ...
                    <Col xs={24} md={12}>
                        ...
                        >
                            <InputNumber
                                ...
                                size={screens.xs ? 'middle' : 'large'}
                                disabled={loading}
                                placeholder={isMobileOrTablet ? "Số lượng đề *" : ""}
                            />
                        </Form.Item>
                    </Col>
                </Row>
                    ...
                    {rows.map((row, index) => (
                        ...
                        >
                            {!isMobileOrTablet ? (
                                ...
                                <>
                                    ...
                                    <Row gutter={[4, 4]} style={{ marginBottom: '4px' }}>
                                        <Col span={spans.grade}>
                                            <Text style={{ fontSize: '11px', color: '#666' }}>Khối lớp</Text>
                                        </Col>
                                        <Col span={spans.unit}>
                                            <Text style={{ fontSize: '11px', color: '#666' }}>Unit</Text>
                                        </Col>
                                        <Col span={spans.skill}>
                                            <Text style={{ fontSize: '11px', color: '#666' }}>Kỹ năng</Text>
                                        </Col>
                                        ...
                                        <Col span={spans.category}>
                                            <Text style={{ fontSize: '11px', color: '#666' }}>
                                                <span style={{ color: '#ff4d4f' }}>* </span>Loại tuỳ chọn
                                            </Text>
                                        </Col>
                                        <Col span={spans.difficulty}>
                                            <Text style={{ fontSize: '11px', color: '#666' }}>Mức độ</Text>
                                        </Col>
                                        <Col span={spans.count}>
                                            <Text style={{ fontSize: '11px', color: '#666' }}>Số câu</Text>
                                        </Col>
                                        <Col span={spans.action}></Col>
                                    </Row>
                                ...
                                // Mobile & Tablet layout - Chỉ hiển thị placeholder, không có labels
